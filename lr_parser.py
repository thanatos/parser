...
class Terminal(object):
    ...
    For example, in Python, the string "raise" would be a terminal. These are
    the deepest nodes the the AST, what you actually see in grammar being
    parsed.
    """
...
class Grammar(object):
    ...
    def __init__(self, productions, starting_symbol):
        ...
        self._starting_symbol = NonTerminal('S')
...
def closure(item_set, grammar):
    ...
    while queue:
        ...
        if parser_expecting_symbol is None:
            continue
        if isinstance(parser_expecting_symbol, NonTerminal):
